 ...
 * configured "Root Directory"). This copy covers Root Directory = repo root;
 * an identical copy lives in frontend/ for Root Directory = frontend. Only the
 * one at the actual deployment root activates — the other is inert.
 *

  ...
  return (
    <div className="rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      <table className="w-full text-xs">
        <thead>
          <tr className="bg-[#0057A8] text-white uppercase tracking-wider">
        ...
        <tbody className="divide-y divide-gray-100">
          {plan.criteria.map(c => (
            <tr
              key={c.id}
              className="bg-white hover:bg-gray-50 transition-colors border-l-4 border-transparent hover:border-[#0057A8]"
            >
              <td className="px-4 py-3 text-gray-800 font-medium">{c.name}</td>
              <td className="px-4 py-3 text-right">
                <span className="bg-[#0057A8]/10 text-[#0057A8] font-mono font-bold text-sm rounded-full px-2 py-0.5">
                  {c.max_points}
                </span>
              </td>
          ...
          <tr className="bg-gray-50 border-t-2 border-gray-200">
            ...
            <td className="px-4 py-2 text-right font-bold text-[#0057A8] font-mono">
